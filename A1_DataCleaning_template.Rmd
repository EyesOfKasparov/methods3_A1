...
ggplot(demodata, aes(VinelandStandardScore)) + 
...
# 3: An important part of the experiment is to look at the changes in language production 
#    and how that rate is different from ASD and TD children - therefore we need the 
#    complete data (also more data is often better)
```